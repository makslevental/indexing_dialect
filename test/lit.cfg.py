...
config.test_exec_root = os.path.join(config.indexing_build_root, 'test')
...
config.indexing_tools_dir = os.path.join(config.indexing_build_root, 'bin')
tool_dirs = [config.indexing_tools_dir, config.llvm_tools_dir]
tools = [
    'mlir-opt',
...
indexing_python_path = os.path.join(config.indexing_build_root,
                                    'python_packages')
llvm_config.with_environment('PYTHONPATH', [indexing_python_path],
                             append_path=True)
